...
class MqClient(
    ...
    fun <R : Any> performRequestResponseSpring(
        queue: String,
        request: Any,
    ): R {
        ...
        return try {
            ...
            throw MQServiceException(
                "Feil mot MQ med uuid=$uuid mot kø: $queue med request: ${objectMapper.writeValueAsString(request)}",
                e,
            )
        }
    }
